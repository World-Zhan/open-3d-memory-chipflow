...
def run(root, run_id):
    ...
    files = [source_netlist, source_checkpoint, geometry_path, pg_path,
        root/'scripts/run_croc_io_floorplan_pg_snapshot.py', root/'scripts/add_io_ring_connected_leads.tcl',
    ...
    manifest = {'schema_version': '1.0.0', 'run_id': run_id, 'started_at': now(), 'status': 'running',
        ...
        'headless_gui_platform': 'offscreen', 'supersedes_failed_run': 'croc-full-io-floorplan-20260905-002', 'connectivity_snapshot_stage': 'after_original_explicit_power_connect_before_physical_generation',
