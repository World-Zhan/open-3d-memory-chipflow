...
def run(root,rid,source_id):
    ...
    paths=[source/'manifest.json',source/'io_ring.odb',root/'scripts/add_io_ring_leads.tcl',
       root/'scripts/run_io_ring_physical.py',root/'scripts/run_io_ring_floorplan.py',
    ...
    try:
        phase('leads',['openroad','-exit','/work/scripts/add_io_ring_leads.tcl'])
