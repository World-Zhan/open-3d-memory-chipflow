...
io_instances = [inst for inst in chip.each_inst() if inst.cell.name == 'sg13g2_IOPadIn' and inst.bbox() == expected_io_box]
...
result = {'schema_version': '1.0.0', 'classification': 'read_only_neighborhood_geometry_not_signoff',
          ...
          'selected_io_bbox_def_um': bbox(expected_io_box, dbu), 'selected_pad_bbox_def_um': bbox(pad_box, dbu),
